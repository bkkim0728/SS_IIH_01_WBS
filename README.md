...
| **WBS 트리** | L1~L4 계층, 계획시작·계획종료, 진척 막대(읽기 전용), 상태 변경, 선택 삭제, 검색, 필터, 엑셀 왕복 |
...
엑셀 반영이나 삭제로 하위가 바뀌면 상위가 즉시 따라옵니다. 간트도 같은 값을 씁니다.
...
| 작업명 · 담당자 | ✅ | |
| 계획시작 · 계획종료 | ✅ | 셀 서식은 **아무거나 써도 됩니다.** 아래 참고 |
